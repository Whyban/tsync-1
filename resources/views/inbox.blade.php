          ...
          <div class="card">
            ...
            <div class="card-body p-0">
              <ul class="nav nav-pills flex-column">
                ...
                <li class="nav-item">
                  <a href="#" class="nav-link">
                    <i class="fas fa-angle-double-right text-warning"></i> Promotions
                  </a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link">
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                    ...
                    <td class="mailbox-name"><a href="read-mail.html">Username Here</a></td>
                    <td class="mailbox-subject">Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
                    </td>
